...
const Sidebar = () =>{
    ...
    return (
        ...
        <div className='Sidebar'>
            ...
            <Link to="/Rooms" className='menuItem' id='option'>
          <div>
          ...
          <div className='NavigateNext'>
            <MdOutlineNavigateNext />
                ...
                <Link to="/Users" className='menuItem' id='option'>
        <div>
            <ImUsers />
        </div>
        <span>Users</span>
        <div className='NavigateNext'>
            <MdOutlineNavigateNext />
                ...
                <Link to='/Reports' className='menuItem' id='option'>
                    <div>
                        <MdReport/>
                    </div>
                    <span>Reports</span>
                ...
                <Link to='/Assistance' className='menuItem' id='option'>
                    <div>
                        <BiSolidCommentError/>
                    </div>
